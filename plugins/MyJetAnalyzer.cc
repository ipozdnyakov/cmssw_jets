...
//TRIGGERS
	...
	cout << names.triggerName(i) << "\n";
	if(names.triggerName(i) == "HLT_DiPFJet15_NoCaloMatched_v1"){
		if(triggerBits->accept(i)) CNTR = triggerPrescales->getPrescaleForIndex(i);
	}
	if(names.triggerName(i) == "HLT_DiPFJet15_FBEta2_NoCaloMatched_v1"){
		if(triggerBits->accept(i)) FWD2 = triggerPrescales->getPrescaleForIndex(i);
	}
	if(names.triggerName(i) == "HLT_DiPFJet15_FBEta3_NoCaloMatched_v1"){
